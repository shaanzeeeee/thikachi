                ...
                <div className="left">
                    ...
                    <div className="dropdown">
                        ...
                        <div className="diningDropdownOptions">
                            <Link to={ROUTES.MENU_INFO + "/Khabar Dabar"} className="link">
                                <span className="highlight">Khabar Dabar</span>
                            </Link>
                            <Link to={ROUTES.MENU_INFO + "/D-Cafe"} className="link">
                                <span className="highlight">D-Cafe</span>
                            </Link>
