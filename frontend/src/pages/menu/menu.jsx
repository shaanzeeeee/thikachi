...
const Menu = () => {
    ...
    // dining court names
    const Khabar_Dabar = "Khabar Dabar";
    ...
    const handleClickLocation = () => {
        if (location === Khabar_Dabar) {
            window.open(Khabar_ADDR, "_blank");
        }
    };
    ...
    useEffect(() => {
        if (location === Khabar_Dabar) {
            setNumber("+880 1403446688");
            setEmail("info@khabardabarcatering.com");
            setLoc("House # 150/B, Tejgaon Industrial Area. Dhaka-1208");
        }
    }, [location]);
